...
class TutorSignup extends React.Component {
    ...
    handleSubmit = async event => {
        ...
        const data = {name: this.state.name , phone: this.state.phone, email: this.state.email,  password: this.state.password , gender: this.state.gender, address : this.state.address, expertise : this.state.expertise}
        console.log(data);
                    ...
                    <div className="auth-content">
                        ...
                        <div className="card">
                            <div className="card-body text-center">
                                ...
                                <div className="input-group mb-4">
                                    <select name="gender" value={this.state.gender || ''} onChange={this.handleChange} className="form-control">
